...
export const achievements: Achievement[] = [
  ...
  },
  {
    ...
    rank: 2,
    rankLabel: "2. Sıra",
    organization: "Bursa Uludağ Üniversitesi Kütüphane ve Dokümantasyon Daire Başkanlığı",
    date: "2026",
    description:
      "BUÜ 62. Kütüphane Haftası kapsamında düzenlenen 'Benim Dünyam Benim Kütüphanem' konseptli video müzik yarışmasında 2. oldum. Yarışmada müziği yapay zeka ile ürettim; kütüphane sevgisini ve okuma kültürünü yansıtan özgün bir içerik ortaya koydum. Ödül töreni Rektör Yardımcısı ve Daire Başkanı'nın katılımıyla gerçekleştirildi.",
    linkedin: "https://www.linkedin.com/feed/update/urn:li:activity:7465796323427045376/",
    images: [
      "/images/achievments/Kutuphane yarisma.jpg",
      "/images/achievments/kutuphane yarisma2.jpg",
    ],
  },
  {
